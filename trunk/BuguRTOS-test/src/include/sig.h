...
*                CAUTION !!!                *
*                                           *
* This implementation is not o(1).          *
* Because o(1) is too fat,                  *
* and won't work on hotplug MP systems,LOL. *
*                                           *
********************************************/
typedef struct _sig{
#ifdef CONFIG_MP
    ...
    lock_t gp_lock;
#endif
    proc_queue_t rt_queue;
    proc_queue_t gp_queue;
} sig_t;

void sig_init(sig_t * sig);
// wait 4 sigal (used in proc->code())
