...
Критическая секция - область кода в которой запрещены все прерывания,
критические секции используются, когда надо использовать общий ресурс в течении короткого ввремени.
...
\return
 ID процессороного ядра, на котором выполняется.

*/
core_id_t _enter_crit_sec(void);
/*!

\brief Выход из критическую секцию на многопроцессорной системе

\param core ID процессороного ядра, на котором выполняется.

\warning Передавших в качестве параметра ID любого другого процессорного ядра ждут Страшный суд, Ад и Погибель.
Молитвы, пост и радио "Радонеж" не помогут, я гарантирую это.
*/
