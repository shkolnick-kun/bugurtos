...
extern load_t load_calc( sched_t * sched );
extern void resched_extern( sched_t * sched );
#endif
// resched tasks on current processor, and switch context if needed
extern void resched_local(void);
// resched tasks on all processors, and switch context if needed
extern void resched_system(void);

#ifdef CONFIG_MP
extern sched_t * current_sched(void);
#else
#define current_sched() ((sched_t *)(&system_sched))
#endif

/************************************************************
*                       4 internal use                      *
************************************************************/
sched_t * _enter_crit_sec(void); // 4 1st crit_sec enter
extern void _enter_crit_sec_2(sched_t * sched); // 4 consequent crit sec's enters
extern void _exit_crit_sec(sched_t * sched);
...
#ifdef CONFIG_MP
RSYS_ISR_ATTR extern void RESCHED_SYSTEM_ISR(void);
REXT_ISR_ATTR extern void RESCHED_EXTERN_ISR(void);
#endif
