...
int main(void)
{
    ...
    **************************************************/
    ...
    bgrt_proc_init_isr( &proc[2], main_with_return,   SVH2, RSH2, 0, &bgrt_proc_stack[2][BGRT_PROC_STACK_SIZE-1], 0,      2, 0 ARG_END );
    bgrt_proc_init_isr( &proc[3], main_with_return,   SVH3, RSH3, 0, &bgrt_proc_stack[3][BGRT_PROC_STACK_SIZE-1], 1,      2, 0 ARG_END );
