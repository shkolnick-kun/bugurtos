...
Ипсользуется для управления доступом к общим ресурсам, в тех случаях, когда общий ресурс нужен в течении долгого времени.
...
\warning Мьютексы захватываются и освобожаются только процессами. Нельзя делать это из обработчиков прерываний, того, кто так сделает ждут... Ну ты понел...
...
/*!
\brief
Захват мьютекса, для внутреннего пользования.
