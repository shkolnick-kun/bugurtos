...
\warning Распространяется под лицензией GPLv3. Если хотите другую лицензию - пишите на фейк: shkolnick.kun@gmail.com.
*/
/*!
\file
...
\return указатель на вершин подготовленного стекау.
*/
