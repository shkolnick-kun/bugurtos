...
Написано анонимусом ради ЛУЛЗОВ.
\warning Распространяется под лицензией GPLv3. Если хотите другую лицензию - пишите на E-mail: shkolnick.kun@gmail.com.
*/
...
//======================================================
/*!
\typedef typedef void (* code_t)(void *);
\brief
Исполняемый код.
