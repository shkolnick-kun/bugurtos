...
Если параметр stop - истина (не ноль), то после возобновления работы процесса делается попытка остановить процесс по флагу PROC_FLG_PRE_END.
...
Если параметр stop - истина (не ноль), то после этого делается попытка остановить процесс, вызвавший функцию sem_unlock по флагу PROC_FLG_PRE_END.
