...
extern void bgrt_kernel_preemt_hook(void);
#ifdef BGRT_CONFIG_PREEMPTIVE_KERNEL
#define BGRT_KERNEL_PREEMPT() bgrt_enable_interrupts(); bgrt_disable_interrupts(); bgrt_kernel_preemt_hook()
#else // BGRT_CONFIG_PREEMPTIVE_KERNEL
#define BGRT_KERNEL_PREEMPT() bgrt_kernel_preemt_hook()
